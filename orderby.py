...
expr7 = t.order_by(["a", ibis.desc("c")])

expr8 = t.order_by([ibis.desc("b"), "a"])
...
if __name__ == "__main__":
    ...
    if len(args) != 2:
        print("help>>>")
        print("\t python orderby.py <path-to-save-directory>")
        
    elif os.path.exists(args[1]):
        write_sql_and_json(base_path=args[1], exprs=[expr7, expr8])
    else:
